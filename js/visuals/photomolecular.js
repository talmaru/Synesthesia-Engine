...
(function () {
  ...
  // The chemistry sim is fixed; nothing here is audio-reactive on its own. Every param is a plain
  // slider — attach modulators in the player (⟳) to decide what the music drives.
  // Good ones to try: treble → glowScale, energy → beatHeat, a beat envelope → clusterBlast.
